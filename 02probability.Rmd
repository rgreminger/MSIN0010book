...
Alternatively, we can use the "lower.tail=" option to tell R we want the probability *greater than* x. However, note that this is *strictly greater than*, so we must again remember than $P(X\geq 20)=P(X>19)$.
